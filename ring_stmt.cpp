...
int ring_parser_class(Parser* pParser)
{
         ...
         */
         ...
         if (ring_parser_iskeyword(pParser,K_FROM))
         {
            ...
            if (ring_parser_namedotname(pParser))
            {
               ...
               #if RING_PARSERTRACE
               RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Class' Identifier 'From' [PackageName'.']Identifier");
               #endif
            }
            else
            {
         ...
         else
         {
            ...
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Class' Identifier ");
            #endif
         }
   ...
   if (ring_parser_iskeyword(pParser,K_FUNC))
   {
      ...
      if (ring_parser_isidentifier(pParser))
      {
         ...
         */
         ...
         if (x == 1)
         {
            RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Func' Identifier [ParaList]");
         }
         #endif
         return x;
      }
   ...
   if (ring_parser_iskeyword(pParser,K_PACKAGE))
   {
      ...
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Package' Identifier{'.'identifier}");
      #endif
      if (ring_parser_namedotname(pParser))
      {
   ...
   if (ring_parser_iskeyword(pParser,K_IMPORT))
   {
      ...
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Import' Identifier{'.'identifier}");
      #endif
   ...
   if (ring_parser_iskeyword(pParser,K_PRIVATE))
   {
      ...
      if (pParser->nClassStart == 1)
      {
         ...
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Private'");
         #endif
...
int ring_parser_stmt(Parser* pParser)
{
   ...
   if (ring_parser_iskeyword(pParser,K_LOAD))
   {
      ...
      if (ring_parser_isliteral(pParser))
      {
         ...
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Load' Literal");
         #endif
   ...
   if (ring_parser_iskeyword(pParser,K_SEE))
   {
      ...
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'See' Expr");
      #endif
      return x;
   }
   ...
   if (ring_parser_iskeyword(pParser,K_GIVE))
   {
      ...
      if (ring_parser_isidentifier(pParser))
      {
         ...
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Give' Identifier|ListItem|Object.Attribute");
         #endif
         return 1;
      }
      else
      ...
      if (ring_parser_isidentifier(pParser))
      {
               ...
               */
               ...
               if (ring_parser_iskeyword(pParser,K_TO))
               {
                  ...
                  if (ring_parser_expr(pParser))
                  {
                     ...
                     #if RING_PARSERTRACE
                     RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'For' Identifier '=' Expr to Expr ['step' Expr]");
                     #endif
                     ...
                     if (ring_parser_iskeyword(pParser,K_NEXT))
                     {
                        ...
                        ring_parser_nexttoken(pParser);
                        #if RING_PARSERTRACE
                        RING_STATE_CHECKPRINTRULES puts  ("Rule : Next --> 'Next'");
                        #endif
                        ring_string_delete(pString);
                        return 1;
                     }
         ...
         else if (ring_parser_iskeyword(pParser,K_IN))
         {
            ...
            if (ring_parser_expr(pParser))
            {
               ...
               #if RING_PARSERTRACE
               RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'For' Identifier 'in' Expr ['step' Expr]");
               #endif
               while (ring_parser_stmt(pParser))
               {
                  if (pParser->ActiveToken == pParser->TokensCount)
   ...
   if (ring_parser_iskeyword(pParser,K_IF))
   {
      ...
      if (ring_parser_expr(pParser))
      {
         ...
         */
         ...
         pMark = ring_parser_icg_getactiveoperation(pParser);
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'If' Expr {Statement} { But } [Else] Ok");
         #endif
         while (ring_parser_stmt(pParser))
         {
            if (pParser->ActiveToken == pParser->TokensCount)
         ...
         while (ring_parser_iskeyword(pParser,K_BUT))
         {
            ...
            if (ring_parser_expr(pParser))
            {
               ...
               pMark = ring_parser_icg_getactiveoperation(pParser);
               #if RING_PARSERTRACE
               RING_STATE_CHECKPRINTRULES puts  ("Rule : But --> 'But' Expr {Statement}");
               #endif
               while (ring_parser_stmt(pParser))
               {
                  if (pParser->ActiveToken == pParser->TokensCount)
         ...
         if (ring_parser_iskeyword(pParser,K_ELSE))
         {
            ...
            ring_parser_nexttoken(pParser);
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule : Else --> 'Else' {Statement} ");
            #endif
            while (ring_parser_stmt(pParser))
            {
               if (pParser->ActiveToken == pParser->TokensCount)
         ...
         if (ring_parser_iskeyword(pParser,K_OK))
         {
            ...
            ring_parser_nexttoken(pParser);
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule : Ok --> 'OK'");
            #endif
            return 1;
         }
         else
   ...
   if (ring_parser_iskeyword(pParser,K_WHILE))
   {
      ...
      */
      ...
      if (ring_parser_expr(pParser))
      {
         ...
         pMark = ring_parser_icg_getactiveoperation(pParser);
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'While' Expr {Statement} End");
         #endif
         while (ring_parser_stmt(pParser))
         {
            if (pParser->ActiveToken == pParser->TokensCount)
         ...
         if (ring_parser_iskeyword(pParser,K_END))
         {
            ...
            ring_parser_nexttoken(pParser);
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule : End --> 'End'");
            #endif
            return 1;
         }
         else
   ...
   if (ring_parser_iskeyword(pParser,K_DO))
   {
      ...
      */
      ...
      ring_parser_nexttoken(pParser);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Do' {Statement} Again");
      #endif
      while (ring_parser_stmt(pParser))
      {
         if (pParser->ActiveToken == pParser->TokensCount)
      ...
      if (ring_parser_iskeyword(pParser,K_AGAIN))
      {
         ...
         if (ring_parser_expr(pParser))
         {
            ...
            pParser->nAssignmentFlag = 1;
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule : Again --> 'Again' Expr");
            #endif
            return 1;
         }
      }
   ...
   if (ring_parser_iskeyword(pParser,K_RETURN))
   {
      ...
      if (x == 1)
      {
         RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Return'");
      }
      #endif
      return x;
   }
   ...
   if (ring_parser_iskeyword(pParser,K_TRY))
   {
      ...
      pMark = ring_parser_icg_getactiveoperation(pParser);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Try' {Statement} Catch Done");
      #endif
      while (ring_parser_stmt(pParser))
      {
         if (pParser->ActiveToken == pParser->TokensCount)
      ...
      if (ring_parser_iskeyword(pParser,K_CATCH))
      {
         ...
         */
         ...
         ring_parser_icg_addoperandint(pMark,nMark1);
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts  ("Rule : Catch --> 'Catch' {Statement}");
         #endif
         while (ring_parser_stmt(pParser))
         {
            if (pParser->ActiveToken == pParser->TokensCount)
         ...
         {
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule : Done --> 'Done'");
            #endif
            ring_parser_nexttoken(pParser);
            /* Generate Code */
            ring_parser_icg_newoperation(pParser,ICO_JUMP);
   ...
   if (ring_parser_iskeyword(pParser,K_BYE))
   {
      ring_parser_nexttoken(pParser);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Bye' ");
      #endif
      /* Generate Code */
   ...
   if (ring_parser_iskeyword(pParser,K_EXIT))
   {
      ring_parser_nexttoken(pParser);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Exit' ");
      #endif
      /* Generate Code */
   ...
   if (ring_parser_iskeyword(pParser,K_LOOP))
   {
      ring_parser_nexttoken(pParser);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> 'Loop'");
      #endif
      /* Generate Code */
   ...
   if (ring_parser_iskeyword(pParser,K_SWITCH))
   {
      ...
      if (ring_parser_expr(pParser))
      {
         pParser->nAssignmentFlag = 1;
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts                       ("Rule : Statement --> 'Switch' Expr {ON} [Other] OFF");
         #endif
         ...
         while (ring_parser_iskeyword(pParser,K_ON))
         {
            ...
            if (ring_parser_expr(pParser))
            {
               ...
               #if RING_PARSERTRACE
               RING_STATE_CHECKPRINTRULES puts  ("Rule : ON --> 'on' Expr {Statement}");
               #endif
               while (ring_parser_stmt(pParser))
               {
                  if (pParser->ActiveToken == pParser->TokensCount)
         ...
         if (ring_parser_iskeyword(pParser,K_OTHER))
         {
            ...
            ring_parser_icg_newoperation(pParser,ICO_FREESTACK);
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule : Other --> 'Other' {Statement}");
            #endif
            while (ring_parser_stmt(pParser))
            {
               if (pParser->ActiveToken == pParser->TokensCount)
         ...
         if (ring_parser_iskeyword(pParser,K_OFF))
         {
            ...
            ring_parser_icg_newoperation(pParser,ICO_FREESTACK);
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule : OFF --> 'Off'");
            #endif
            return 1;
         }
         else
   ...
   {
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : Statement --> Expr ");
      #endif
      ring_parser_icg_newoperation(pParser,ICO_FREESTACK);
      return 1;
   }
...
int ring_parser_paralist(Parser* pParser)
{
   ...
   if (ring_parser_isendline(pParser))
   {
      ring_parser_nexttoken(pParser);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : ParaList --> Epslion ");
      #endif
      return 1;
   }
   ...
   if (ring_parser_isidentifier(pParser))
   {
      ...
      ring_parser_icg_newoperand(pParser,pParser->TokenText);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule : ParaList --> Identifier {',' Identifier}");
      #endif
      ring_parser_nexttoken(pParser);
...
int ring_parser_list(Parser* pParser)
{
   ...
   if (ring_parser_isoperator(pParser,"["))
   {
      ...
      if (ring_parser_isoperator(pParser,"]"))
      {
         ...
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts  ("Rule : List --> '[' Expr { ',' Expr } ']' ");
         #endif
         return 1;
      }
      while (1)
...
int ring_parser_epslion(Parser* pParser)
{
   if (ring_parser_isendline(pParser))
   {
      ...
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES printf   ("\nLine %d \n",pParser->nLineNumber);
      #endif
