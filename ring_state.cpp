...
static void ring_testallunits();
#endif
#if RING_TESTPERFORMANCE

static void ring_showtime();
#endif
...
RING_API RingState* ring_state_new()
{
   RingState*  pRingState;

   pRingState = new RingState;
...
RING_API void ring_print_line()
{
   puts("==================================================================");
}

RING_API RingState* ring_state_init()
{
...
RING_API List* ring_state_newvar(RingState* pRingState,const char* cStr)
{
   ...
   List*    pList = (List*)RING_VM_STACK_READP;    
