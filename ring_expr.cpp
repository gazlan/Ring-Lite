...
int ring_parser_expr(Parser* pParser)
{
   ...
   if (ring_parser_logicnot(pParser))
   {
      x = 1;
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Expr --> LogicNot");
      #endif
...
int ring_parser_logicnot(Parser* pParser)
{
   ...
   if (ring_parser_iskeyword(pParser,K_NOT))
   {
      ...
      if (x == 1)
      {
         RING_STATE_CHECKPRINTRULES puts  ("Rule; LogicNot -> 'not' EqualOrNot ");
      }
      #endif
      /* Generate Code */
   ...
   if (x == 1)
   {
      RING_STATE_CHECKPRINTRULES puts  ("Rule; LogicNot -> EqualOrNot ");
   }
   #endif
   return x;
}
...
int ring_parser_equalornot(Parser* pParser)
{
   ...
   if (ring_parser_compare(pParser))
   {
      x = 1;
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; EqualOrNot --> Compare");
      #endif
...
int ring_parser_compare(Parser* pParser)
{
   ...
   if (ring_parser_bitorxor(pParser))
   {
      x = 1;
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Compare --> BitOrXOR");
      #endif
      while (ring_parser_isoperator(pParser,"<") || ring_parser_isoperator(pParser,">"))
      {
         nEqual = 0;
...
int ring_parser_bitorxor(Parser* pParser)
{
   ...
   if (ring_parser_bitand(pParser))
   {
      x = 1;
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; BitOrXOR --> BitAnd");
      #endif
      while (ring_parser_isoperator(pParser,"|") || ring_parser_isoperator(pParser,"^"))
      {
         if (ring_parser_isoperator(pParser,"|"))
...
int ring_parser_bitand(Parser* pParser)
{
   ...
   if (ring_parser_bitshift(pParser))
   {
      x = 1;
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; BitAnd --> BitShift");
      #endif
...
int ring_parser_bitshift(Parser* pParser)
{
   ...
   if (ring_parser_arithmetic(pParser))
   {
      x = 1;
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; BitShift --> Arithmetic");
      #endif
      while (ring_parser_isoperator(pParser,"<<") || ring_parser_isoperator(pParser,">>"))
      {
         if (ring_parser_isoperator(pParser,"<<"))
...
int ring_parser_arithmetic(Parser* pParser)
{
   ...
   {
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Arithmetic --> Term");
      #endif
      x = 1;
      while (ring_parser_isoperator(pParser,"+") || ring_parser_isoperator(pParser,"-"))
      {
...
int ring_parser_term(Parser* pParser)
{
   ...
   if (ring_parser_range(pParser))
   {
      x = 1;
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Term --> Range");
      #endif
...
int ring_parser_factor(Parser* pParser,int* nFlag)
{
   ...
   *nFlag = 0;
   ...
   if (ring_parser_isidentifier(pParser))
   {
      ...
      */
      ...
      if ((lequal == 1) && (pParser->nAssignmentFlag == 1))
      {
         ...
         if (x == 1)
         {
            RING_STATE_CHECKPRINTRULES puts  ("Rule; Assignment -> '=' Expr ");
         }
         #endif
         /* Generate Code */
   ...
   if (ring_parser_isnumber(pParser))
   {
      ...
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Factor --> Number");
      #endif
      ring_parser_nexttoken(pParser);
      /* ++ and -- */
      if (ring_parser_ppmm(pParser))
   ...
   if (ring_parser_isliteral(pParser))
   {
      ...
      ring_parser_icg_newoperand(pParser,pParser->TokenText);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Factor --> Literal");
      #endif
      ring_parser_nexttoken(pParser);
      /* Array Index & Object Dot */
      x = ring_parser_mixer(pParser);
   ...
   if (ring_parser_isoperator(pParser,"-"))
   {
      ...
      ring_parser_icg_newoperandint(pParser,0);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Factor --> '-' Expr");
      #endif
      return x;
   }
   else if (ring_parser_isoperator(pParser,"~"))
   ...
   if (ring_parser_isoperator(pParser,"("))
   {
      ...
      if (ring_parser_expr(pParser))
      {
         pParser->nAssignmentFlag = (char) x;
         if (ring_parser_isoperator(pParser,")"))
         {
            ring_parser_nexttoken(pParser);
            #if RING_PARSERTRACE
   ...
   if (ring_parser_isoperator(pParser,"["))
   {
      ...
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Factor --> List");
      #endif
      return x;
   }
   ...
   if (ring_parser_iskeyword(pParser,K_NEW))
   {
      ...
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Factor --> New Identifier {'.' Identifier } ");
      #endif
      ...
      */
      ...
      if (ring_parser_isoperator(pParser,"{"))
      {
         ...
         if (ring_parser_isoperator(pParser,"}"))
         {
            ...
            ring_parser_icg_addoperandint(pMark,nMark);
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule; AnonymousFunction --> Func ParaList '{' Statement '}'");
            #endif
            return 1;
         }
      }
...
int ring_parser_mixer(Parser* pParser)
{
   ...
   while (ring_parser_isoperator(pParser,"."))
   {
      ...
      if (ring_parser_isidentifier(pParser))
      {
         ...
         ring_parser_icg_newoperandint(pParser,0);
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts  ("Rule; Mixer -> '.' Identifier ");
         #endif
         ring_parser_nexttoken(pParser);
      }
      else
   ...
   if (ring_parser_isoperator(pParser,"["))
   {
      ...
      if (ring_parser_expr(pParser))
      {
         ...
         if (ring_parser_isoperator(pParser,"]"))
         {
            ring_parser_nexttoken(pParser);
            #if RING_PARSERTRACE
            RING_STATE_CHECKPRINTRULES puts  ("Rule; Mixer -> '[' Expr ']' ");
            #endif
            x = ring_parser_mixer(pParser);
            if (x == 0)
            {
   ...
   if (ring_parser_isoperator(pParser,"("))
   {
      ...
      if (ring_parser_isoperator(pParser,")"))
      {
         ...
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts                       ("Rule; Mixer -> '(' [Expr { ',' Expr} ] ')' ");
         #endif
                                    RING_PARSER_IGNORENEWLINE;
         /* Function Call Only */
      ...
      while (1)
      {
         ...
         if (ring_parser_expr(pParser))
         {
            pParser->nAssignmentFlag = (char) nFlag;
            RING_PARSER_IGNORENEWLINE;
            if (ring_parser_isoperator(pParser,","))
            {
               ring_parser_nexttoken(pParser);
   ...
   if (ring_parser_isoperator(pParser,"{"))
   {
      ...
      ring_parser_icg_newoperation(pParser,ICO_BRACESTART);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; Mixer --> '{' {Statement} BraceEnd");
      #endif
      ring_parser_nexttoken(pParser);
      ...
      pParser->nAssignmentFlag = (char) nStatus;
      ...
      if (ring_parser_isoperator(pParser,"}"))
      {
         ...
         */
         ...
         ring_parser_icg_newoperation(pParser,ICO_BRACEEND);
         #if RING_PARSERTRACE
         RING_STATE_CHECKPRINTRULES puts  ("Rule; BraceEnd --> '}' ");
         #endif
         ring_parser_nexttoken(pParser);
         x = ring_parser_mixer(pParser);
         return x;
...
int ring_parser_ppmm(Parser* pParser)
{
   ...
   if (ring_parser_isoperator(pParser,"++"))
   {
      ...
      ring_parser_icg_newoperation(pParser,ICO_PUSHV);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; PlusPlus --> '++'");
      #endif
      return 1;
   }
   else if (ring_parser_isoperator(pParser,"--"))
   {
      ...
      ring_parser_icg_newoperation(pParser,ICO_PUSHV);
      #if RING_PARSERTRACE
      RING_STATE_CHECKPRINTRULES puts  ("Rule; MinusMinus --> '--'");
      #endif
      return 1;
   }
   return 0;
